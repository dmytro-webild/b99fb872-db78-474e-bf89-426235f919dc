...
export const metadata: Metadata = {
  title: "NSL Life & Finances | Insurance & Debt Solutions",  description: "Professional life insurance and debt management solutions. Always striving to be where we are needed most. Get personalized financial protection today.",  keywords: "life insurance, debt solutions, financial planning, debt consolidation, family protection",  metadataBase: new URL("https://nsllifefinances.com"),
  alternates: {
    canonical: "https://nsllifefinances.com"
  },
  openGraph: {
    title: "NSL Life & Finances | Insurance & Debt Solutions",    description: "Comprehensive life insurance and debt management solutions tailored to your needs.",    type: "website",    siteName: "NSL Life & Finances"
  },
  twitter: {
    card: "summary_large_image",    title: "NSL Life & Finances | Insurance & Debt Solutions",    description: "Professional financial protection and debt management services."
  },
  robots: {
    index: true,
    follow: true
